...
const zones = [
    ...
    { name: "Snare",     x: 450, y: 225, w: 225, h: 225, color:"#d9d9d9", pos3d: [1, 0.8, -0.8], radius: 1, rotation: -Math.PI / 12, glowColor: "#ffffff" },
    ...
    { name: "Tom_floor", x: 675, y: 225, w: 225, h: 225, color:"#4d4d4d", pos3d: [-2, 0.8, -0.8], radius: 1.2, rotation: -Math.PI / 9, glowColor: "#aaaaaa" },
];
