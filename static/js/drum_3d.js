...
const zones = [
    { name: "Hihat",     x: 675, y: 225, w: 225, h: 225, color:"#3232ff", pos3d: [3, 0.8, -0.5], radius: 1.0, rotation: -Math.PI / 9 },
    { name: "Snare",     x: 450, y: 225, w: 225, h: 225, color:"#d9d9d9", pos3d: [0.8, 0.2, -0.5], radius: 1, rotation: -Math.PI / 9 },
    { name: "Tom_high",  x: 450, y: 0,   w: 225, h: 225, color:"#ff7f2a", pos3d: [1, 1, 1.5], radius: 0.8, rotation: -Math.PI / 9 },
    { name: "Tom_mid",   x: 450, y: 0,   w: 225, h: 225, color:"#ff7f2a", pos3d: [-1, 1, 1.5], radius: 0.8, rotation: -Math.PI / 9 },
